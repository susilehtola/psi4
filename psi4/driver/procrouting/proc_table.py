...
from .dft import build_superfunctional_from_dictionary, superfunctional_available, functionals
...
for key in functionals:
    # Only register functionals whose LibXC dependencies are present in the linked LibXC build.
    # Avoids blanket `import psi4` error for unbuildable functionals #3474 .
    if not superfunctional_available(functionals[key]):
        continue
